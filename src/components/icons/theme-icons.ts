...
// Theme Mode Icons
@customElement('icon-light-mode')
export class LightModeIcon extends IconBase {
  protected render() {
    return html`
...
@customElement('icon-dark-mode')
export class DarkModeIcon extends IconBase {
  protected render() {
    return html`
      <svg viewBox="0 0 24 24" part="svg">
        <path
...
// Customization Icons
@customElement('icon-palette')
export class PaletteIcon extends IconBase {
  protected render() {
    return html`
      <svg viewBox="0 0 24 24" part="svg">
        <path
...
@customElement('icon-brush')
export class BrushIcon extends IconBase {
  protected render() {
    return html`
      <svg viewBox="0 0 24 24" part="svg">
        <path
...
@customElement('icon-contrast')
export class ContrastIcon extends IconBase {
  protected render() {
    return html`
      <svg viewBox="0 0 24 24" part="svg">
        <path
...
@customElement('icon-opacity')
export class OpacityIcon extends IconBase {
  protected render() {
    return html`
      <svg viewBox="0 0 24 24" part="svg">
        <path
...
@customElement('icon-format-color-fill')
export class FormatColorFillIcon extends IconBase {
  protected render() {
    return html`
      <svg viewBox="0 0 24 24" part="svg">
        <path
...
declare global {
  interface HTMLElementTagNameMap {
    'icon-light-mode': LightModeIcon;
    'icon-dark-mode': DarkModeIcon;
    'icon-palette': PaletteIcon;
    'icon-brush': BrushIcon;
    'icon-contrast': ContrastIcon;
    'icon-opacity': OpacityIcon;
    'icon-format-color-fill': FormatColorFillIcon;
  }
}
